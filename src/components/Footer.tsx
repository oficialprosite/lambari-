      ...
      <div className="mx-auto max-w-[1440px] px-6 py-14 md:px-10">
        <div className="flex flex-col justify-between gap-10 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-white/40">{site.descricao}</p>
          </div>
          ...
          <div className="flex flex-col gap-1.5 md:items-end">
            ...
            {site.telefones.map((telefone) => (
              <a
                ...
                className="font-mono text-sm text-white/60 transition-colors duration-300 hover:text-ember"
              >
                {telefone.rotulo}
              </a>
            ))}
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span className="label text-white/25">
            Campinas — SP · Desde {site.fundacao}
          </span>
        </div>
      </div>
    </footer>
